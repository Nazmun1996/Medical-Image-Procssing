...
subMenu.add_command(label="Insert Alzheimer", command=needTodo)
subMenu.add_command(label="Scan Alzheimer", command=needTodo)
...
insertBar = Button(toolbar, text="Scan Alzhiemer", command=needTodo)
insertBar.pack(side=RIGHT, padx=2, pady=2)

insertBar = Button(toolbar, text="Insert Alzheimer File", command=needTodo)
insertBar.pack(side=RIGHT, padx=2, pady=2)
