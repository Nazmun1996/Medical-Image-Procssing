...
subMenu.add_command(label="Insert Kidney Stone", command=needTodo)
subMenu.add_command(label="Scan Kidney Stone", command=needTodo)
...
insertBar = Button(toolbar, text="Scan Kidney Stone", command=needTodo)
insertBar.pack(side=RIGHT, padx=2, pady=2)

insertBar = Button(toolbar, text="Insert Kidney Stone File", command=needTodo)
insertBar.pack(side=RIGHT, padx=2, pady=2)
