...
subMenu.add_command(label="Insert Fetus", command=needTodo)
subMenu.add_command(label="Scan Fetus", command=needTodo)
...
insertBar = Button(toolbar, text="Scan Fetus", command=needTodo)
insertBar.pack(side=RIGHT, padx=2, pady=2)

insertBar = Button(toolbar, text="Insert Fetus File", command=needTodo)
insertBar.pack(side=RIGHT, padx=2, pady=2)
